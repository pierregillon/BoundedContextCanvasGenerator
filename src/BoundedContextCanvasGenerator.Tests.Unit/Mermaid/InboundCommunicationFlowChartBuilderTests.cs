...
public class InboundCommunicationFlowChartBuilder2Tests
{
    [Fact]
    public void Cannot_generate_flowchart_from_empty_inbound_communication()
    {
        Action action = () => _ = new InboundCommunicationFlowChartBuilder2(InboundCommunication.Empty);
...
```");
    ...
    {
        var builder = new InboundCommunicationFlowChartBuilder2(inboundCommunication);
