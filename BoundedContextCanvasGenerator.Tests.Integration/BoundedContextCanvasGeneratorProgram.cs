...
public record BoundedContextCanvasGeneratorProgram
{
    ...
    public BoundedContextCanvasGeneratorProgram TargettingSolution(string relativePath)
    {
        this._solutionAbsolutePath = GetAbsoluteSolutionPath(relativePath);
        return this;
    }

    public BoundedContextCanvasGeneratorProgram OutputingFile(string path)
    {
